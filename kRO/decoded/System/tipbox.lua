...
, 
[71] = {Title = "페코페코 관리병#나이트,크루세이더,라이딩,대여,탈것,타기,관리병,페코페코", Search = 1, Image = "유저인터페이스\\tipbox\\tip00071", 
Imgcoord = {Position = 5, Size = 100}
, 
...
, 
[72] = {Title = "거수 관리병#룬나이트,로얄가드,탈것,타기,드래곤,그리폰,거수,관리병", Search = 1, Image = "유저인터페이스\\tipbox\\tip00072", 
Imgcoord = {Position = 5, Size = 100}
, 
Page = {"룬나이트, 로얄가드로 전직 시, 드래곤, 그리폰을 탈 수 있습니다.\n\n\t거수 관리병\'은 각 도시의 \'안내요원\' NPC를 통해 위치를 검색 할 수 있습니다."}
}
, 
[73] = {Title = "호문클루스#엠브리오,생명윤리,제작,리프,아미스트르,필리르,바닐미르스", Search = 1, Image = "유저인터페이스\\tipbox\\tip00073", 
Imgcoord = {Position = 5, Size = 100}
, 
